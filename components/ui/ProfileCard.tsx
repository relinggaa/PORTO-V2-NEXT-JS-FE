...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  return (
    <div
      ref={wrapRef}
      className={`relative touch-none w-full max-w-full ${className}`.trim()}
      style={{ perspective: '500px', transform: 'translate3d(0, 0, 0.1px)', maxWidth: '100%', ...cardStyle } as React.CSSProperties}
    >
      {behindGlowEnabled && (
        <div
      ...
      <div ref={shellRef} className="relative z-[1] group">
        <section
          ...
          style={{
            height: 'clamp(300px, 80svh, 540px)',
            maxHeight: '540px',
            maxWidth: '100%',
            aspectRatio: '0.718',
            borderRadius: cardRadius,
